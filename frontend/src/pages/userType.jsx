      ...
      <div className="user-type-selector">
        ...
        >
          ...
          <div className="user-info">
            <h2>Driver</h2>
            <p>Experienced drivers ready to take you to your destination. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="user-info">
            <h2>Passenger</h2>
            <p>Relax and enjoy the journey as a passenger with our reliable drivers. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </div>
        </div>
      </div>
